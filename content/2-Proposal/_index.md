...
The project aims to build a learning ecosystem that balances **iron discipline** and **healthy entertainment**:
...
*   **Client (Frontend - Offline First):** Built with ReactJS and packaged with Electron into a standalone Desktop app. State management uses Redux and Electron-store.
